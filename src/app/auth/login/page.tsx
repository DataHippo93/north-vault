          ...
          {mode === 'login' ? (
            <>
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                <div>
                  <label className="block text-sm font-medium text-sage-300 mb-1.5">Email</label>
                  <input
                    type="email"
                    value={email}
                ...
                <div>
                  <label className="block text-sm font-medium text-sage-300 mb-1.5">Password</label>
                  <input
                    type="password"
                    value={password}
              ...
              <button
                ...
                className="mt-5 text-sm text-sage-400 hover:text-vault-400 w-full text-center transition-colors cursor-pointer"
              >
                Forgot password?
              </button>
            </>
            ...
            <>
              ...
              {resetSent ? (
                <div className="text-sm text-vault-300 bg-vault-900/30 border border-vault-500/20 rounded-lg px-4 py-3 mt-4">
