  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        <h2 className="text-base font-semibold text-slate-900 mb-3">Tools</h2>
        <Link
          href="/admin/import"
          className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#4a5a3f] text-white rounded-lg text-sm font-medium hover:bg-[#3d4b34] transition-colors"
        >
